                            ...
                            <table className="table table-bordered">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.trm_house.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.amount_fiat?.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.commission_cumbi?.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.iva?.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.gmf?.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    $
                                    {selectedDeposit.amount_to_receive_in_bank?.toLocaleString()}
                                    {' '}
                                    COP
                                  </td>
                                </tr>
