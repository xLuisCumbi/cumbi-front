...
function Settings() {
    ...
    const handleFormSubmit = e => {
        ...
        for (let i in settingsFormData) {
            ...
            if (settingsFormData[i] !== '****************' && settingsFormData[i] != '') {
        ...
        ApiService.post('/update', { ...data })
            .then((response) => {
                ...
                if (response.status === "success") {
                    ...
                    const up_user = {...user, email: settingsFormData.email, username: settingsFormData.username}
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mt-3">
                            ...
                            <input
                                ...
                                onChange={(e) => setSettingsFormData({ ...settingsFormData, passphrase: e.target.value })}
                                required
                            />
                        </div>
                        <div className="col-md-6 mt-3">
                        ...
                        <div className="col-md-12 mt-4 text-center">
                            ...
                            <button className="btn btn-primary text-white"> Update Admin Data </button>
