...
function ListUserBusiness(props) {
  ...
  const blockUser = (_id, status) => {
    ...
    if (!status || status === 'active') newStatus = 'blocked';
              ...
              <div className="modal-dialog modal-lg">
                <div className="modal-content">
                  <div className="modal-header">
                    ...
                    <button type="button" className="btn-close" onClick={() => setShowPdfModal(false)} />
                  </div>
                  <div className="modal-body">
                    ...
                    >
                      <Page pageNumber={1} />
                      {' '}
                      {/* Puedes cambiar el número de página si es necesario */}
                    </Document>
                  </div>
