...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e(require('@popperjs/core')) : typeof define === 'function' && define.amd ? define(['@popperjs/core'], e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = e(t.Popper); }(this, ((t) => {
  function e(t) { const e = Object.create(null, { [Symbol.toStringTag]: { value: 'Module' } }); if (t) for (const s in t) if (s !== 'default') { const i = Object.getOwnPropertyDescriptor(t, s); Object.defineProperty(e, s, i.get ? i : { enumerable: !0, get: () => t[s] }); } return e.default = t, Object.freeze(e); } const s = e(t); const i = new Map(); const n = { set(t, e, s) { i.has(t) || i.set(t, new Map()); const n = i.get(t); n.has(e) || n.size === 0 ? n.set(e, s) : console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(n.keys())[0]}.`); }, get: (t, e) => i.has(t) && i.get(t).get(e) || null, remove(t, e) { if (!i.has(t)) return; const s = i.get(t); s.delete(e), s.size === 0 && i.delete(t); } }; const o = 'transitionend'; const r = (t) => (t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, ((t, e) => `#${CSS.escape(e)}`))), t); const a = (t) => { t.dispatchEvent(new Event(o)); }; const l = (t) => !(!t || typeof t !== 'object') && (void 0 !== t.jquery && (t = t[0]), void 0 !== t.nodeType); const c = (t) => (l(t) ? t.jquery ? t[0] : t : typeof t === 'string' && t.length > 0 ? document.querySelector(r(t)) : null); const h = (t) => { if (!l(t) || t.getClientRects().length === 0) return !1; const e = getComputedStyle(t).getPropertyValue('visibility') === 'visible'; const s = t.closest('details:not([open])'); if (!s) return e; if (s !== t) { const e = t.closest('summary'); if (e && e.parentNode !== s) return !1; if (e === null) return !1; } return e; }; const d = (t) => !t || t.nodeType !== Node.ELEMENT_NODE || !!t.classList.contains('disabled') || (void 0 !== t.disabled ? t.disabled : t.hasAttribute('disabled') && t.getAttribute('disabled') !== 'false'); const u = (t) => { if (!document.documentElement.attachShadow) return null; if (typeof t.getRootNode === 'function') { const e = t.getRootNode(); return e instanceof ShadowRoot ? e : null; } return t instanceof ShadowRoot ? t : t.parentNode ? u(t.parentNode) : null; }; const _ = () => {}; const g = (t) => { t.offsetHeight; }; const f = () => (window.jQuery && !document.body.hasAttribute('data-bs-no-jquery') ? window.jQuery : null); const m = []; const p = () => document.documentElement.dir === 'rtl'; const b = (t) => { let e; e = () => { const e = f(); if (e) { const s = t.NAME; const i = e.fn[s]; e.fn[s] = t.jQueryInterface, e.fn[s].Constructor = t, e.fn[s].noConflict = () => (e.fn[s] = i, t.jQueryInterface); } }, document.readyState === 'loading' ? (m.length || document.addEventListener('DOMContentLoaded', (() => { for (const t of m)t(); })), m.push(e)) : e(); }; const v = (t, e = [], s = t) => (typeof t === 'function' ? t(...e) : s); const y = (t, e, s = !0) => { if (!s) return void v(t); const i = ((t) => { if (!t) return 0; let { transitionDuration: e, transitionDelay: s } = window.getComputedStyle(t); const i = Number.parseFloat(e); const n = Number.parseFloat(s); return i || n ? (e = e.split(',')[0], s = s.split(',')[0], 1e3 * (Number.parseFloat(e) + Number.parseFloat(s))) : 0; })(e) + 5; let n = !1; const r = ({ target: s }) => { s === e && (n = !0, e.removeEventListener(o, r), v(t)); }; e.addEventListener(o, r), setTimeout((() => { n || a(e); }), i); }; const w = (t, e, s, i) => { const n = t.length; let o = t.indexOf(e); return o === -1 ? !s && i ? t[n - 1] : t[0] : (o += s ? 1 : -1, i && (o = (o + n) % n), t[Math.max(0, Math.min(o, n - 1))]); }; const A = /[^.]*(?=\..*)\.|.*/; const E = /\..*/; const C = /::\d+$/; const T = {}; let k = 1; const S = { mouseenter: 'mouseover', mouseleave: 'mouseout' }; const L = new Set(['click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover', 'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup', 'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change', 'reset', 'select', 'submit', 'focusin', 'focusout', 'load', 'unload', 'beforeunload', 'resize', 'move', 'DOMContentLoaded', 'readystatechange', 'error', 'abort', 'scroll']); function O(t, e) { return e && `${e}::${k++}` || t.uidEvent || k++; } function I(t) { const e = O(t); return t.uidEvent = e, T[e] = T[e] || {}, T[e]; } function D(t, e, s = null) { return Object.values(t).find(((t) => t.callable === e && t.delegationSelector === s)); } function N(t, e, s) { const i = typeof e === 'string'; const n = i ? s : e || s; let o = j(t); return L.has(o) || (o = t), [i, n, o]; } function P(t, e, s, i, n) { if (typeof e !== 'string' || !t) return; let [o, r, a] = N(e, s, i); if (e in S) { const t = (t) => function (e) { if (!e.relatedTarget || e.relatedTarget !== e.delegateTarget && !e.delegateTarget.contains(e.relatedTarget)) return t.call(this, e); }; r = t(r); } const l = I(t); const c = l[a] || (l[a] = {}); const h = D(c, r, o ? s : null); if (h) return void (h.oneOff = h.oneOff && n); const d = O(r, e.replace(A, '')); const u = o ? (function (t, e, s) { return function i(n) { const o = t.querySelectorAll(e); for (let { target: r } = n; r && r !== this; r = r.parentNode) for (const a of o) if (a === r) return $(n, { delegateTarget: r }), i.oneOff && F.off(t, n.type, e, s), s.apply(r, [n]); }; }(t, s, r)) : (function (t, e) { return function s(i) { return $(i, { delegateTarget: t }), s.oneOff && F.off(t, i.type, e), e.apply(t, [i]); }; }(t, r)); u.delegationSelector = o ? s : null, u.callable = r, u.oneOff = n, u.uidEvent = d, c[d] = u, t.addEventListener(a, u, o); } function x(t, e, s, i, n) { const o = D(e[s], i, n); o && (t.removeEventListener(s, o, Boolean(n)), delete e[s][o.uidEvent]); } function M(t, e, s, i) { const n = e[s] || {}; for (const [o, r] of Object.entries(n))o.includes(i) && x(t, e, s, r.callable, r.delegationSelector); } function j(t) { return t = t.replace(E, ''), S[t] || t; } const F = {
  ...
  } function R(t) { let e = t.getAttribute('data-bs-target'); if (!e || e === '#') { let s = t.getAttribute('href'); if (!s || !s.includes('#') && !s.startsWith('.')) return null; s.includes('#') && !s.startsWith('#') && (s = `#${s.split('#')[1]}`), e = s && s !== '#' ? s.trim() : null; } return r(e); } const K = {
  ...
  }; const V = (t, e = 'hide') => { const s = `click.dismiss${t.EVENT_KEY}`; const i = t.NAME; F.on(document, s, `[data-bs-dismiss="${i}"]`, (function (s) { if (['A', 'AREA'].includes(this.tagName) && s.preventDefault(), d(this)) return; const n = K.getElementFromSelector(this) || this.closest(`.${i}`); t.getOrCreateInstance(n)[e](); })); }; class Q extends W {
  ...
  }V(Q, 'close'), b(Q); const X = '[data-bs-toggle="button"]'; class Y extends W {
    ...
    constructor(t, e) { super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = K.findOne('.carousel-indicators', this._element), this._addEventListeners(), this._config.ride === nt && this.cycle(); }
    ...
    _addTouchEventListeners() { for (const t of K.find('.carousel-item img', this._element))F.on(t, 'dragstart.bs.carousel', ((t) => t.preventDefault())); const t = { leftCallback: () => this._slide(this._directionToOrder(et)), rightCallback: () => this._slide(this._directionToOrder(st)), endCallback: () => { this._config.pause === 'hover' && (this.pause(), this.touchTimeout && clearTimeout(this.touchTimeout), this.touchTimeout = setTimeout((() => this._maybeEnableCycle()), 500 + this._config.interval)); } }; this._swipeHelper = new J(this._element, t); }
    ...
    _setActiveIndicatorElement(t) { if (!this._indicatorsElement) return; const e = K.findOne('.active', this._indicatorsElement); e.classList.remove(ot), e.removeAttribute('aria-current'); const s = K.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement); s && (s.classList.add(ot), s.setAttribute('aria-current', 'true')); }
  ...
  }F.on(document, 'click.bs.carousel.data-api', '[data-bs-slide], [data-bs-slide-to]', (function (t) { const e = K.getElementFromSelector(this); if (!e || !e.classList.contains(nt)) return; t.preventDefault(); const s = ct.getOrCreateInstance(e); const i = this.getAttribute('data-bs-slide-to'); return i ? (s.to(i), void s._maybeEnableCycle()) : B.getDataAttribute(this, 'slide') === 'next' ? (s.next(), void s._maybeEnableCycle()) : (s.prev(), void s._maybeEnableCycle()); })), F.on(window, 'load.bs.carousel.data-api', (() => { const t = K.find('[data-bs-ride="carousel"]'); for (const e of t)ct.getOrCreateInstance(e); })), b(ct); const ht = 'show'; const dt = 'collapse'; const ut = 'collapsing'; const _t = '[data-bs-toggle="collapse"]'; const gt = { parent: null, toggle: !0 }; const ft = { parent: '(null|element)', toggle: 'boolean' }; class mt extends W {
    constructor(t, e) { super(t, e), this._isTransitioning = !1, this._triggerArray = []; const s = K.find(_t); for (const t of s) { const e = K.getSelectorFromElement(t); const s = K.find(e).filter(((t) => t === this._element)); e !== null && s.length && this._triggerArray.push(t); } this._initializeChildren(), this._config.parent || this._addAriaAndCollapsedClass(this._triggerArray, this._isShown()), this._config.toggle && this.toggle(); }
    ...
    _initializeChildren() { if (!this._config.parent) return; const t = this._getFirstLevelChildren(_t); for (const e of t) { const t = K.getElementFromSelector(e); t && this._addAriaAndCollapsedClass([e], this._isShown(t)); } }
    ...
    constructor(t, e) { super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = K.next(this._element, Tt)[0] || K.prev(this._element, Tt)[0] || K.findOne(Tt, this._parent), this._inNavbar = this._detectNavbar(); }
    ...
    _selectMenuItem({ key: t, target: e }) { const s = K.find('.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)', this._menu).filter(((t) => h(t))); s.length && w(s, e, t === vt, !s.includes(e)).focus(); }
    ...
    static clearMenus(t) { if (t.button === 2 || t.type === 'keyup' && t.key !== 'Tab') return; const e = K.find(Ct); for (const s of e) { const e = xt.getInstance(s); if (!e || !1 === e._config.autoClose) continue; const i = t.composedPath(); const n = i.includes(e._menu); if (i.includes(e._element) || e._config.autoClose === 'inside' && !n || e._config.autoClose === 'outside' && n) continue; if (e._menu.contains(t.target) && (t.type === 'keyup' && t.key === 'Tab' || /input|select|option|textarea|form/i.test(t.target.tagName))) continue; const o = { relatedTarget: e._element }; t.type === 'click' && (o.clickEvent = t), e._completeHide(o); } }

    static dataApiKeydownHandler(t) { const e = /input|textarea/i.test(t.target.tagName); const s = t.key === 'Escape'; const i = [bt, vt].includes(t.key); if (!i && !s) return; if (e && !s) return; t.preventDefault(); const n = this.matches(Et) ? this : K.prev(this, Et)[0] || K.next(this, Et)[0] || K.findOne(Et, t.delegateTarget.parentNode); const o = xt.getOrCreateInstance(n); if (i) return t.stopPropagation(), o.show(), void o._selectMenuItem(t); o._isShown() && (t.stopPropagation(), o.hide(), n.focus()); }
    ...
    _handleFocusin(t) { const { trapElement: e } = this._config; if (t.target === document || t.target === e || e.contains(t.target)) return; const s = K.focusableChildren(e); s.length === 0 ? e.focus() : this._lastTabNavDirection === Bt ? s[s.length - 1].focus() : s[0].focus(); }

    _handleKeydown(t) { t.key === 'Tab' && (this._lastTabNavDirection = t.shiftKey ? Bt : 'forward'); }
  } const Kt = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top'; const Vt = '.sticky-top'; const Qt = 'padding-right'; const Xt = 'margin-right'; class Yt {
    constructor() { this._element = document.body; }

    getWidth() { const t = document.documentElement.clientWidth; return Math.abs(window.innerWidth - t); }

    hide() { const t = this.getWidth(); this._disableOverFlow(), this._setElementAttributes(this._element, Qt, ((e) => e + t)), this._setElementAttributes(Kt, Qt, ((e) => e + t)), this._setElementAttributes(Vt, Xt, ((e) => e - t)); }

    reset() { this._resetElementAttributes(this._element, 'overflow'), this._resetElementAttributes(this._element, Qt), this._resetElementAttributes(Kt, Qt), this._resetElementAttributes(Vt, Xt); }
    ...
    _applyManipulationCallback(t, e) { if (l(t))e(t); else for (const s of K.find(t, this._element))e(s); }
    ...
    constructor(t, e) { super(t, e), this._dialog = K.findOne('.modal-dialog', this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new Yt(), this._addEventListeners(); }
  ...
  }F.on(document, 'click.bs.modal.data-api', '[data-bs-toggle="modal"]', (function (t) { const e = K.getElementFromSelector(this); ['A', 'AREA'].includes(this.tagName) && t.preventDefault(), F.one(e, Jt, ((t) => { t.defaultPrevented || F.one(e, Gt, (() => { h(this) && this.focus(); })); })); const s = K.findOne('.modal.show'); s && ne.getInstance(s).hide(), ne.getOrCreateInstance(e).toggle(this); })), V(ne), b(ne); const oe = 'show'; const re = 'showing'; const ae = 'hiding'; const le = '.offcanvas.show'; const ce = 'hidePrevented.bs.offcanvas'; const he = 'hidden.bs.offcanvas'; const de = { backdrop: !0, keyboard: !0, scroll: !1 }; const ue = { backdrop: '(boolean|string)', keyboard: 'boolean', scroll: 'boolean' }; class _e extends W {
  ...
  }F.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]', (function (t) { const e = K.getElementFromSelector(this); if (['A', 'AREA'].includes(this.tagName) && t.preventDefault(), d(this)) return; F.one(e, he, (() => { h(this) && this.focus(); })); const s = K.findOne(le); s && s !== e && _e.getInstance(s).hide(), _e.getOrCreateInstance(e).toggle(this); })), F.on(window, 'load.bs.offcanvas.data-api', (() => { for (const t of K.find(le))_e.getOrCreateInstance(t).show(); })), F.on(window, 'resize.bs.offcanvas', (() => { for (const t of K.find('[aria-modal][class*=show][class*=offcanvas-]'))getComputedStyle(t).position !== 'fixed' && _e.getOrCreateInstance(t).hide(); })), V(_e), b(_e); const ge = {
    '*': ['class', 'dir', 'id', 'lang', 'role', /^aria-[\w-]*$/i], a: ['target', 'href', 'title', 'rel'], area: [], b: [], br: [], col: [], code: [], div: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [], img: ['src', 'srcset', 'alt', 'title', 'width', 'height'], li: [], ol: [], p: [], pre: [], s: [], small: [], span: [], sub: [], sup: [], strong: [], u: [], ul: [],
  }; const fe = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']); const me = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i; const pe = (t, e) => { const s = t.nodeName.toLowerCase(); return e.includes(s) ? !fe.has(s) || Boolean(me.test(t.nodeValue)) : e.filter(((t) => t instanceof RegExp)).some(((t) => t.test(s))); }; const be = {
    allowList: ge, content: {}, extraClass: '', html: !1, sanitize: !0, sanitizeFn: null, template: '<div></div>',
  }; const ve = {
    ...
    _setContent(t, e, s) { const i = K.findOne(s, t); i && ((e = this._resolvePossibleFunction(e)) ? l(e) ? this._putElementInTemplate(c(e), i) : this._config.html ? i.innerHTML = this._maybeSanitize(e) : i.textContent = e : i.remove()); }
    ...
    allowList: ge, animation: !0, boundary: 'clippingParents', container: !1, customClass: '', delay: 0, fallbackPlacements: ['top', 'right', 'bottom', 'left'], html: !1, offset: [0, 6], placement: 'top', popperConfig: null, sanitize: !0, sanitizeFn: null, selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', title: '', trigger: 'hover focus',
  }; const De = {
    ...
    dispose() { clearTimeout(this._timeout), F.off(this._element.closest(Te), ke, this._hideModalHandler), this._element.getAttribute('data-bs-original-title') && this._element.setAttribute('title', this._element.getAttribute('data-bs-original-title')), this._disposePopper(), super.dispose(); }
    ...
    _createPopper(t) { const e = v(this._config.placement, [this, t, this._element]); const i = Oe[e.toUpperCase()]; return s.createPopper(this._element, t, this._getPopperConfig(i)); }
  ...
  }b(Me); const je = 'click.bs.scrollspy'; const Fe = 'active'; const $e = '[href]'; const ze = {
    ...
    _maybeEnableSmoothScroll() { this._config.smoothScroll && (F.off(this._config.target, je), F.on(this._config.target, je, $e, ((t) => { const e = this._observableSections.get(t.target.hash); if (e) { t.preventDefault(); const s = this._rootElement || window; const i = e.offsetTop - this._element.offsetTop; if (s.scrollTo) return void s.scrollTo({ top: i, behavior: 'smooth' }); s.scrollTop = i; } }))); }
    ...
    _initializeTargetsAndObservables() { this._targetLinks = new Map(), this._observableSections = new Map(); const t = K.find($e, this._config.target); for (const e of t) { if (!e.hash || d(e)) continue; const t = K.findOne(decodeURI(e.hash), this._element); h(t) && (this._targetLinks.set(decodeURI(e.hash), e), this._observableSections.set(e.hash, t)); } }

    _process(t) { this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(Fe), this._activateParents(t), F.trigger(this._element, 'activate.bs.scrollspy', { relatedTarget: t })); }

    _activateParents(t) { if (t.classList.contains('dropdown-item'))K.findOne('.dropdown-toggle', t.closest('.dropdown')).classList.add(Fe); else for (const e of K.parents(t, '.nav, .list-group')) for (const t of K.prev(e, '.nav-link, .nav-item > .nav-link, .list-group-item'))t.classList.add(Fe); }

    _clearActiveClass(t) { t.classList.remove(Fe); const e = K.find('[href].active', t); for (const t of e)t.classList.remove(Fe); }
  ...
  }F.on(window, 'load.bs.scrollspy.data-api', (() => { for (const t of K.find('[data-bs-spy="scroll"]'))Be.getOrCreateInstance(t); })), b(Be); const qe = 'ArrowLeft'; const We = 'ArrowRight'; const Re = 'ArrowUp'; const Ke = 'ArrowDown'; const Ve = 'active'; const Qe = 'fade'; const Xe = 'show'; const Ye = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]'; const Ue = `.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ${Ye}`; class Ge extends W {
    ...
    _activate(t, e) { t && (t.classList.add(Ve), this._activate(K.getElementFromSelector(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.removeAttribute('tabindex'), t.setAttribute('aria-selected', !0), this._toggleDropDown(t, !0), F.trigger(t, 'shown.bs.tab', { relatedTarget: e })) : t.classList.add(Xe); }), t, t.classList.contains(Qe))); }

    _deactivate(t, e) { t && (t.classList.remove(Ve), t.blur(), this._deactivate(K.getElementFromSelector(t)), this._queueCallback((() => { t.getAttribute('role') === 'tab' ? (t.setAttribute('aria-selected', !1), t.setAttribute('tabindex', '-1'), this._toggleDropDown(t, !1), F.trigger(t, 'hidden.bs.tab', { relatedTarget: e })) : t.classList.remove(Xe); }), t, t.classList.contains(Qe))); }

    _keydown(t) { if (![qe, We, Re, Ke].includes(t.key)) return; t.stopPropagation(), t.preventDefault(); const e = [We, Ke].includes(t.key); const s = w(this._getChildren().filter(((t) => !d(t))), t.target, e, !0); s && (s.focus({ preventScroll: !0 }), Ge.getOrCreateInstance(s).show()); }

    _getChildren() { return K.find(Ue, this._parent); }
    ...
    _setInitialAttributesOnTargetPanel(t) { const e = K.getElementFromSelector(t); e && (this._setAttributeIfNotExists(e, 'role', 'tabpanel'), t.id && this._setAttributeIfNotExists(e, 'aria-labelledby', `${t.id}`)); }

    _toggleDropDown(t, e) { const s = this._getOuterElement(t); if (!s.classList.contains('dropdown')) return; const i = (t, i) => { const n = K.findOne(t, s); n && n.classList.toggle(i, e); }; i('.dropdown-toggle', Ve), i('.dropdown-menu', Xe), s.setAttribute('aria-expanded', e); }

    _setAttributeIfNotExists(t, e, s) { t.hasAttribute(e) || t.setAttribute(e, s); }

    _elemIsActive(t) { return t.classList.contains(Ve); }

    _getInnerElement(t) { return t.matches(Ue) ? t : K.findOne(Ue, t); }
    ...
    show() { F.trigger(this._element, 'show.bs.toast').defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add('fade'), this._element.classList.remove(Je), g(this._element), this._element.classList.add(Ze, ts), this._queueCallback((() => { this._element.classList.remove(ts), F.trigger(this._element, 'shown.bs.toast'), this._maybeScheduleHide(); }), this._element, this._config.animation)); }

    hide() { this.isShown() && (F.trigger(this._element, 'hide.bs.toast').defaultPrevented || (this._element.classList.add(ts), this._queueCallback((() => { this._element.classList.add(Je), this._element.classList.remove(ts, Ze), F.trigger(this._element, 'hidden.bs.toast'); }), this._element, this._config.animation))); }
    ...
    Alert: Q, Button: Y, Carousel: ct, Collapse: mt, Dropdown: xt, Modal: ne, Offcanvas: _e, Popover: Me, ScrollSpy: Be, Tab: Ge, Toast: is, Tooltip: Ne,
  };
})));
